...
import {
  itemIndex as fetchIndex,
  itemDeleteList as fetchDelete,
  itemCleanFail as fetchCleanFail,
...
const mapStateToProps = ({ screen, services }) => ({
  onLoading: screen.itemLists.screen.onLoading || false,
  items: screen.itemLists.screen.data || {},
  errorMessage: screen.itemLists.screen.errorMessage || '',
})
