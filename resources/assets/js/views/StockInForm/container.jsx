...
import {
  stockInDetail as fetchDetail,
  stockInSave as fetchSave,
  stockInUpdate as fetchUpdate,
} from '../../repositories/stockIn'
import { itemAllIndex as fetchItemIndex } from '../../repositories/item'
import { STOCK_IN_SAVE_FAIL } from '../../constants/stockIn';
...
const mapStateToProps = ({ screen, services }, props) => {
  ...
  return {
    onLoading: screen.stockInLists.detail.onLoading || false,
    stockIn: screen.stockInLists.detail.data || null,
    id,
    items: screen.itemLists.screen.data || [],
    errorMessage: screen.stockInLists.detail.errorMessage || '',
    isError: screen.stockInLists.detail.isError || null,
  }
}
