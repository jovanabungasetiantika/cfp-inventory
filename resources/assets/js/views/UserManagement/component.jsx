...
class UserManagement extends Component {
  ...
  triggerDialog = (id, name) => {
    ...
    openDialog({
      title: `Hapus "${name}" dari Pengguna?`,
      body: '',
      action: async () => {
  ...
  renderTableData = () => {
    ...
    let pagination
    if (users && users.data) {
      let count = users.from || 1
      tableData.push(..._.map(users.data, row => {
        return [
          count++,
          row.name,
          row.email,
        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            <CardHeader color="primary">
              <h4 className={classes.cardTitleWhite}>Pengguna</h4>
            ...
            <CardBody>
              ...
              <Table
                ...
                tableHead={["No.", "Nama Pengguna", "Email", "Tanggal Input", ""]}
                tableData={tableData}
