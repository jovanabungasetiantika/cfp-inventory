...
import {
  stockOutIndexReport as fetchReport,
  stockOutCleanFail as fetchCleanFail,
  stockOutReport,
...
const mapStateToProps = ({ screen, services }) => ({
  onLoading: screen.stockOutLists.screen.onLoading || false,
  stocks: screen.stockOutLists.screen.data || {},
  errorMessage: screen.stockOutLists.screen.errorMessage || '',
})
...
const mapDispatchToProps = dispatch => ({
  ...
  stockReport(...params) {
    return dispatch(stockOutReport(...params))
  },
  openDialog(...params) {
